...
public class Die extends Event {
  ...
  public final static int typeIndexID = JCasRegistry.register(Die.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Die() {/* intentionally empty block */}
    
  /** Internal - constructor used by generator 
   * @generated */
  public Die(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public Die(JCas jcas) {
    super(jcas);
    readObject();   
  } 

  /** @generated */  
  public Die(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
