 ...
 * @generated */
public class GPE extends Entity {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected GPE() {/* intentionally empty block */}
    
  /** Internal - constructor used by generator 
   * @generated */
  public GPE(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public GPE(JCas jcas) {
    super(jcas);
    readObject();   
  } 

  /** @generated */  
  public GPE(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
